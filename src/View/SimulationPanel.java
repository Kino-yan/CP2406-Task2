...
public class SimulationPanel extends JPanel {
    ...
    private void createVehicle() {
        int randomVehicle = random.nextInt(5);
        switch (randomVehicle) {
            ...
            case 2:
                ...
                break;
            case 3:
                vehicles.add(new SchoolBus(Integer.toString(cycle), roads.get(0)));
                break;
            case 4:
                vehicles.add(new Truck(Integer.toString(cycle), roads.get(0)));
                break;
        }
    }
